...
GLAPI void  APIENTRY glGetVertexAttribArrayObjectivATI(GLuint index,GLenum pname,GLint *params)
{
	...
	if(!GL_ENTRY_PTR(glGetVertexAttribArrayObjectivATI_Idx))
	{
            GL_ENTRY_PTR(glGetVertexAttribArrayObjectivATI_Idx) = dlsym(RTLD_NEXT,"glGetVertexAttribArrayObjectivATI");
            if(!GL_ENTRY_PTR(glGetVertexAttribArrayObjectivATI_Idx))
                abort();
	}
