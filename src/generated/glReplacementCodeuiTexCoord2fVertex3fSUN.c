...
GLAPI void  APIENTRY glReplacementCodeuiTexCoord2fVertex3fSUN(GLuint rc,GLfloat s,GLfloat t,GLfloat x,GLfloat y,GLfloat z)
{
	...
	if(!GL_ENTRY_PTR(glReplacementCodeuiTexCoord2fVertex3fSUN_Idx))
	{
            GL_ENTRY_PTR(glReplacementCodeuiTexCoord2fVertex3fSUN_Idx) = dlsym(RTLD_NEXT,"glReplacementCodeuiTexCoord2fVertex3fSUN");
            if(!GL_ENTRY_PTR(glReplacementCodeuiTexCoord2fVertex3fSUN_Idx))
                abort();
	}
