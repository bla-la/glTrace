...
GLAPI void  APIENTRY glGetCombinerOutputParameterfvNV(GLenum stage,GLenum portion,GLenum pname,GLfloat *params)
{
	...
	if(!GL_ENTRY_PTR(glGetCombinerOutputParameterfvNV_Idx))
	{
            GL_ENTRY_PTR(glGetCombinerOutputParameterfvNV_Idx) = dlsym(RTLD_NEXT,"glGetCombinerOutputParameterfvNV");
            if(!GL_ENTRY_PTR(glGetCombinerOutputParameterfvNV_Idx))
                abort();
	}
