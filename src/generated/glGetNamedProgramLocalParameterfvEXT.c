...
GLAPI void  APIENTRY glGetNamedProgramLocalParameterfvEXT(GLuint program,GLenum target,GLuint index,GLfloat *params)
{
	...
	if(!GL_ENTRY_PTR(glGetNamedProgramLocalParameterfvEXT_Idx))
	{
            GL_ENTRY_PTR(glGetNamedProgramLocalParameterfvEXT_Idx) = dlsym(RTLD_NEXT,"glGetNamedProgramLocalParameterfvEXT");
            if(!GL_ENTRY_PTR(glGetNamedProgramLocalParameterfvEXT_Idx))
                abort();
	}
