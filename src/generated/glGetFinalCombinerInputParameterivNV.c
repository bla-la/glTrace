...
GLAPI void  APIENTRY glGetFinalCombinerInputParameterivNV(GLenum variable,GLenum pname,GLint *params)
{
	...
	if(!GL_ENTRY_PTR(glGetFinalCombinerInputParameterivNV_Idx))
	{
            GL_ENTRY_PTR(glGetFinalCombinerInputParameterivNV_Idx) = dlsym(RTLD_NEXT,"glGetFinalCombinerInputParameterivNV");
            if(!GL_ENTRY_PTR(glGetFinalCombinerInputParameterivNV_Idx))
                abort();
	}
