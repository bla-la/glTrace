...
GLAPI void  APIENTRY glNamedProgramLocalParameter4fEXT(GLuint program,GLenum target,GLuint index,GLfloat x,GLfloat y,GLfloat z,GLfloat w)
{
	...
	if(!GL_ENTRY_PTR(glNamedProgramLocalParameter4fEXT_Idx))
	{
            GL_ENTRY_PTR(glNamedProgramLocalParameter4fEXT_Idx) = dlsym(RTLD_NEXT,"glNamedProgramLocalParameter4fEXT");
            if(!GL_ENTRY_PTR(glNamedProgramLocalParameter4fEXT_Idx))
                abort();
	}
