...
GLAPI void  APIENTRY glReplacementCodeuiColor4ubVertex3fvSUN(const GLuint *rc,const GLubyte *c,const GLfloat *v)
{
	...
	if(!GL_ENTRY_PTR(glReplacementCodeuiColor4ubVertex3fvSUN_Idx))
	{
            GL_ENTRY_PTR(glReplacementCodeuiColor4ubVertex3fvSUN_Idx) = dlsym(RTLD_NEXT,"glReplacementCodeuiColor4ubVertex3fvSUN");
            if(!GL_ENTRY_PTR(glReplacementCodeuiColor4ubVertex3fvSUN_Idx))
                abort();
	}
