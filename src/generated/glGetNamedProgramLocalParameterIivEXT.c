...
GLAPI void  APIENTRY glGetNamedProgramLocalParameterIivEXT(GLuint program,GLenum target,GLuint index,GLint *params)
{
	...
	if(!GL_ENTRY_PTR(glGetNamedProgramLocalParameterIivEXT_Idx))
	{
            GL_ENTRY_PTR(glGetNamedProgramLocalParameterIivEXT_Idx) = dlsym(RTLD_NEXT,"glGetNamedProgramLocalParameterIivEXT");
            if(!GL_ENTRY_PTR(glGetNamedProgramLocalParameterIivEXT_Idx))
                abort();
	}
