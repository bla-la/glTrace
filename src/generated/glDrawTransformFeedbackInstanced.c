...
GLAPI void  APIENTRY glDrawTransformFeedbackInstanced(GLenum mode,GLuint id,GLsizei instancecount)
{
	...
	if(!GL_ENTRY_PTR(glDrawTransformFeedbackInstanced_Idx))
	{
            GL_ENTRY_PTR(glDrawTransformFeedbackInstanced_Idx) = dlsym(RTLD_NEXT,"glDrawTransformFeedbackInstanced");
            if(!GL_ENTRY_PTR(glDrawTransformFeedbackInstanced_Idx))
                abort();
	}
