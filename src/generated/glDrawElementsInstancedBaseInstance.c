...
GLAPI void  APIENTRY glDrawElementsInstancedBaseInstance(GLenum mode,GLsizei count,GLenum type,const void *indices,GLsizei instancecount,GLuint baseinstance)
{
	...
	if(!GL_ENTRY_PTR(glDrawElementsInstancedBaseInstance_Idx))
	{
            GL_ENTRY_PTR(glDrawElementsInstancedBaseInstance_Idx) = dlsym(RTLD_NEXT,"glDrawElementsInstancedBaseInstance");
            if(!GL_ENTRY_PTR(glDrawElementsInstancedBaseInstance_Idx))
                abort();
	}
