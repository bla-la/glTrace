...
GLAPI void  APIENTRY glGetProgramSubroutineParameteruivNV(GLenum target,GLuint index,GLuint *param)
{
	...
	if(!GL_ENTRY_PTR(glGetProgramSubroutineParameteruivNV_Idx))
	{
            GL_ENTRY_PTR(glGetProgramSubroutineParameteruivNV_Idx) = dlsym(RTLD_NEXT,"glGetProgramSubroutineParameteruivNV");
            if(!GL_ENTRY_PTR(glGetProgramSubroutineParameteruivNV_Idx))
                abort();
	}
