...
GLAPI void  APIENTRY glNamedRenderbufferStorageMultisampleCoverageEXT(GLuint renderbuffer,GLsizei coverageSamples,GLsizei colorSamples,GLenum internalformat,GLsizei width,GLsizei height)
{
	...
	if(!GL_ENTRY_PTR(glNamedRenderbufferStorageMultisampleCoverageEXT_Idx))
	{
            GL_ENTRY_PTR(glNamedRenderbufferStorageMultisampleCoverageEXT_Idx) = dlsym(RTLD_NEXT,"glNamedRenderbufferStorageMultisampleCoverageEXT");
            if(!GL_ENTRY_PTR(glNamedRenderbufferStorageMultisampleCoverageEXT_Idx))
                abort();
	}
