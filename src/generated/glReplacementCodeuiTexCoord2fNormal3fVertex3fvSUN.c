...
GLAPI void  APIENTRY glReplacementCodeuiTexCoord2fNormal3fVertex3fvSUN(const GLuint *rc,const GLfloat *tc,const GLfloat *n,const GLfloat *v)
{
	...
	if(!GL_ENTRY_PTR(glReplacementCodeuiTexCoord2fNormal3fVertex3fvSUN_Idx))
	{
            GL_ENTRY_PTR(glReplacementCodeuiTexCoord2fNormal3fVertex3fvSUN_Idx) = dlsym(RTLD_NEXT,"glReplacementCodeuiTexCoord2fNormal3fVertex3fvSUN");
            if(!GL_ENTRY_PTR(glReplacementCodeuiTexCoord2fNormal3fVertex3fvSUN_Idx))
                abort();
	}
