...
GLAPI void  APIENTRY glGetFramebufferAttachmentParameterivEXT(GLenum target,GLenum attachment,GLenum pname,GLint *params)
{
	...
	if(!GL_ENTRY_PTR(glGetFramebufferAttachmentParameterivEXT_Idx))
	{
            GL_ENTRY_PTR(glGetFramebufferAttachmentParameterivEXT_Idx) = dlsym(RTLD_NEXT,"glGetFramebufferAttachmentParameterivEXT");
            if(!GL_ENTRY_PTR(glGetFramebufferAttachmentParameterivEXT_Idx))
                abort();
	}
