...
GLAPI void  APIENTRY glDrawElementsInstancedBaseVertex(GLenum mode,GLsizei count,GLenum type,const void *indices,GLsizei instancecount,GLint basevertex)
{
	...
	if(!GL_ENTRY_PTR(glDrawElementsInstancedBaseVertex_Idx))
	{
            GL_ENTRY_PTR(glDrawElementsInstancedBaseVertex_Idx) = dlsym(RTLD_NEXT,"glDrawElementsInstancedBaseVertex");
            if(!GL_ENTRY_PTR(glDrawElementsInstancedBaseVertex_Idx))
                abort();
	}
