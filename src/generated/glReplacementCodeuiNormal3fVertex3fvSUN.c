...
GLAPI void  APIENTRY glReplacementCodeuiNormal3fVertex3fvSUN(const GLuint *rc,const GLfloat *n,const GLfloat *v)
{
	...
	if(!GL_ENTRY_PTR(glReplacementCodeuiNormal3fVertex3fvSUN_Idx))
	{
            GL_ENTRY_PTR(glReplacementCodeuiNormal3fVertex3fvSUN_Idx) = dlsym(RTLD_NEXT,"glReplacementCodeuiNormal3fVertex3fvSUN");
            if(!GL_ENTRY_PTR(glReplacementCodeuiNormal3fVertex3fvSUN_Idx))
                abort();
	}
