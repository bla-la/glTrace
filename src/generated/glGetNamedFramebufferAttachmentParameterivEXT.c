...
GLAPI void  APIENTRY glGetNamedFramebufferAttachmentParameterivEXT(GLuint framebuffer,GLenum attachment,GLenum pname,GLint *params)
{
	...
	if(!GL_ENTRY_PTR(glGetNamedFramebufferAttachmentParameterivEXT_Idx))
	{
            GL_ENTRY_PTR(glGetNamedFramebufferAttachmentParameterivEXT_Idx) = dlsym(RTLD_NEXT,"glGetNamedFramebufferAttachmentParameterivEXT");
            if(!GL_ENTRY_PTR(glGetNamedFramebufferAttachmentParameterivEXT_Idx))
                abort();
	}
